...
<div class="max-w-2xl mx-auto p-4">
    ...
    <form method="POST" action="{{ route('tasks.store') }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="task_name" id="task_name" class="w-full p-2 border rounded" placeholder="e.g., Take out trash" pattern="^[a-zA-Z0-9\s\-_]{3,255}$" oninvalid="this.setCustomValidity('Please enter a valid task name')" oninput="this.setCustomValidity('')" required>
        </div>
